...
public class EvoSQLConfiguration {
	public enum AlgorithmType{
		EvoSQL, MoeSQLnsgaii, MoeSQLmosa, MoeSQLmax, Random
	}
	public static AlgorithmType algorithmType = AlgorithmType.EvoSQL;
	public static String dataSet = "erpnext";

	public static boolean USE_DYNAMIC_OBJECTIVES = false;
	public static boolean IS_FIND_PARETO = false;
	public static boolean USE_PATH_POPULATION_SIZE = false;
	public static boolean IS_GET_MULTI_DATA = false;
	public static boolean USE_MINIMIZE = true;
	public static boolean PRINT_PATH = false;
	public static boolean USE_SIZE = true;
	public static boolean USE_EXHAUSTIVE = false;
